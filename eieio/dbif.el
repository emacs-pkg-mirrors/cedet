;;; dbif Generic Database superclass for handling unique databases
;;;
;;; Copyright (C) 1996 Eric M. Ludlam
;;;
;;; Author: <zappo@gnu.ai.mit.edu>
;;; Version: 0.1
;;; RCS: $Id: dbif.el,v 1.1 1996/03/28 03:31:27 zappo Exp $
...
(defvar dbif-max-parse nil
  "Sets the maximum number of fields to parse before stopping.  If
nil, find everything.")
