...
;; Created: June 2002
;; Keywords: syntax
;; X-RCS: $Id: wisent-python.el,v 1.19 2003/01/06 16:45:55 emacsman Exp $
;;
...
;;
;; * Revisit support for "raw strings" via the raw-string token code that
;;   David wrote.  This adds a run-time execution burden of one regexp match per
;;   each token generated by the lexer!
;;
...
(define-lex-analyzer semantic-lex-python-triple-quotes
...
(define-lex-analyzer semantic-lex-python-raw-string
  "Handle python raw-strings. Return a 'raw-string syntactic token."
  (looking-at wisent-python-raw-string-re)
  (let ((opos (point))
	(e (condition-case nil
		...
		(goto-char
		 (funcall
		  ...
		  opos end))
		(point))))))
    (semantic-lex-token 'raw-string opos e)))
...
;; Same as wisent-java-lex-string. -ryk1/05/03.
(define-lex-regex-analyzer semantic-lex-python-string
...
(define-lex semantic-python-lexer
  ...
  semantic-lex-python-string		;; rather than semantic-lex-string
...
(defconst wisent-python-parser-tables
  ;;DO NOT EDIT! Generated from wisent-python.wy - 2003-01-05 20:11-0800
  (eval-when-compile
