...
;; Created: June 2002
;; Keywords: syntax
;; X-RCS: $Id: wisent-python.el,v 1.36 2003/03/14 05:44:43 emacsman Exp $
;;
...
(defconst wisent-python-parser-tables
  ;;DO NOT EDIT! Generated from wisent-python.wy - 2003-03-13 21:35-0800
  (progn
    (eval-when-compile
      (require 'wisent-comp))
	...
	((testlist expr_stmt_trailer)
	 (if
	     ...
	     (wisent-raw-token
	      (semantic-token-new-variable $1 nil nil))
	   (wisent-token $1 'code nil nil))))
       (expr_stmt_trailer
	((augassign testlist))
	((eq_testlist_zom)))
	...
	((DEF NAME function_parameter_list COLON suite)
	 (wisent-raw-token
	  (semantic-token-new-function $2 nil $3))))
	...
	((MULT NAME)
	 (wisent-raw-token
	  (semantic-token-new-variable $2 nil nil)))
	((EXPONENT NAME)
	 (wisent-raw-token
	  (semantic-token-new-variable $2 nil nil))))
       (class_declaration
	((CLASS NAME paren_class_list_opt COLON suite)
	 (wisent-raw-token
	  (semantic-token-new-type $2 $1 $5 $3))))
	...
	((COMMA EXPONENT NAME)
	 (wisent-raw-token
	  (semantic-token-new-variable $3 nil nil))))
